...
import de.fu_berlin.imp.apiua.server.java_ee.utils.AsyncTester;
...
public class FingerprintRESTTest {
	...
	public FingerprintRESTTest(URL APIUAsrv) {
	...
	public void testGetID() throws Exception {
		...
		assertNull(FingerprintRESTUtils.getID(APIUAsrv, unmappedFingerprint));
		...
		assertNull(FingerprintRESTUtils.getID(APIUAsrv, unmappedFingerprint));
		assertEquals(id, FingerprintRESTUtils.getID(APIUAsrv, mappedFingerprint));
	}

	@Test(expected = UniformInterfaceException.class)
	public void testInvalidChangeFingerprint() throws Exception {
		FingerprintRESTUtils.associate(APIUAsrv, Utils.getTestFingerprint(),
				"!undefined");
	}
	...
	public void testChangeFingerprint() throws Exception {
		...
		assertTrue(FingerprintRESTUtils.associate(APIUAsrv, f1, f2));
		...
		assertTrue(FingerprintRESTUtils.associate(APIUAsrv, f2, f3));
