package de.fu_berlin.imp.apiua.server.java_ee.integration.APIUAclt.web.host;
...
public class ClientIntegrationTest {
	...
	public static Collection<Object[]> data() throws Exception {
		...
		URL[] hostUrls = TestConfiguration.getAPIUAcltWebHostURLs();
	...
	public void clientIsIncluded() throws Exception {
		...
		if (isJQueryIncluded(head)) {
			...
			assertTrue(
					...
					ArrayUtils.contains(Utils.getAPIUAcltWebCode(),
							last.toString()));
		} else if (body != null) {
			if (isJQueryIncluded(body)) {
				...
				fail("APIUAclt.web include could not be found in the head nor in the body.");
			}
		} else {
			fail("APIUAclt.web include could not be found in the head and the a body tag could not be found.");
		}
	}
}
