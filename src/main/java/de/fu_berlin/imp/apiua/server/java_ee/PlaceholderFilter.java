...
import de.fu_berlin.imp.apiua.server.java_ee.servlets.BufferedServletResponse;
 ...
 * <p>
 * If a user asks for
 * <code>http://dalak.imp.fu-berlin.de/static/js/APIUAclt.js</code> the returned
...
public class PlaceholderFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp,
		...
		if ((uri.contains("register.html") || uri.contains("APIUAclt") || uri
				.contains("APIUAsrv"))
